...
function configureOpenClaw(port) {
  ...
  config.agents.defaults.model.primary = 'modelrelay/smartest'

  if (!config.agents.defaults.models) config.agents.defaults.models = {}
  if (!config.agents.defaults.models['modelrelay/smartest']) {
    config.agents.defaults.models['modelrelay/smartest'] = {}
  }
...
function printIntegrationSnippets(port) {
  ...
  const openclawSnippet = [
    ...
    '  "agents": {',
    '    "defaults": {',
    '      "model": { "primary": "modelrelay/smartest" },',
    '      "models": { "modelrelay/smartest": {} }',
    '    }',
    '  }',
    '}',
  ].join('\n')
