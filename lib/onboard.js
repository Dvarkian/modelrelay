...
function configureOpenClaw(port) {
  ...
  config.agents.defaults.model.primary = 'hammer/smartest'

  if (!config.agents.defaults.models) config.agents.defaults.models = {}
  if (!config.agents.defaults.models['hammer/smartest']) {
    config.agents.defaults.models['hammer/smartest'] = {}
  }
...
function printIntegrationSnippets(port) {
  ...
  const openclawSnippet = [
    ...
    '  "agents": {',
    '    "defaults": {',
    '      "model": { "primary": "hammer/smartest" },',
    '      "models": { "hammer/smartest": {} }',
    '    }',
    '  }',
    '}',
  ].join('\n')
